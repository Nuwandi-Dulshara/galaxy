    ...
    <form action="{{ route('admin.offers.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="number" step="0.01" name="original_price" id="original_price" class="form-control"
                value="{{ old('original_price') }}" required oninput="calculateOfferPrice()">
        ...
        <div class="mb-3">
            ...
            <input type="number" step="0.01" name="offer_percentage" id="offer_percentage" class="form-control"
                value="{{ old('offer_percentage') }}" required oninput="calculateOfferPrice()">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="offer_price" class="form-control" readonly>
        </div>
